private ["_marker", "_pos", "_groups", "_civs", "_posArray", "_buildings", "_buildingsnew", "_presence", "_array", "_number"];
...
}forEach (nearestObjects [getMarkerPos _marker,["Building","House"], (selectMax (getMarkerSize _marker))]);
