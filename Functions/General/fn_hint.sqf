...
private ["_heading", "_headingText", "_hintText", "_hintText2", "_type"];

_type = _this select 0;
_hintText =  _this select 1;
_hintText2 =  _this select 2;
...
["
	<t size='1.25' font='puristaMedium' color='#0080ff' align='center' valign='top'>%3:</t>
	<br/>
	<br/>
	%1
	<br/>
...
",_headingText, _hintText, _hintText2];
